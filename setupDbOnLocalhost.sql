...
ALTER TABLE `user` ADD `firstname` VARCHAR(255) NOT NULL COMMENT 'firstname of the user' AFTER `name`, ADD `password` VARCHAR(255) NOT NULL COMMENT 'password of the user' AFTER `firstname`, ADD `class` VARCHAR(255) NOT NULL COMMENT 'class the user belongs to' AFTER `password`;
